...
class FloatingCTAManager {
  ...
  createHTML() {
    ...
    this.elements.ctaWrapper = container.querySelector('.floating-cta-wrapper');
    this.elements.statusIndicator = container.querySelector('.floating-whatsapp-status');
    this.elements.closeButton = container.querySelector('.floating-cta-close');
  }
